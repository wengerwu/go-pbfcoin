...
Please review the resulting diff to check whpbfer the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-pbfcoin authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-pbfcoin Authors
